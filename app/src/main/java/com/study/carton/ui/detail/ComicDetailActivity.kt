...
import com.study.carton.base.ArithHelper
import com.study.carton.base.BaseVMActivity
import com.study.carton.bean.detail.ComicDetailResponse
import com.study.carton.ui.home.HomeSortItemDecoration
import com.study.carton.ui.preview.ComicPreViewActivity
...
class ComicDetailActivity : BaseVMActivity(), BaseQuickAdapter.OnItemChildClickListener,
    ...
    //最近阅读的书
    private var mRecentReadingChapter: ComicDetailResponse.ChapterListBean? = null
    //当前点击listPosition
            ...
            if (it == null) {
                ...
                getAdapter<ChapterAdapter>(rv_list)?.apply {
                    ComicPreViewActivity.openActivity(
                        ...
                        it,
                        data as List<ComicDetailResponse.ChapterListBean>,
                        isReverseList,
        ...
        when (v?.id) {
            R.id.iv_reverse -> {
                rv_list.adapter?.apply {
                    ...
                    data.reverse<ComicDetailResponse.ChapterListBean>()
